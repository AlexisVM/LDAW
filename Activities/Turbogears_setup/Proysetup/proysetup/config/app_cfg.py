# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in Proysetup.
...
import proysetup
from proysetup import model, lib
...
base_config.update_blueprint({
    'use_sqlalchemy': True,
    'model': proysetup.model,
    'DBSession': proysetup.model.DBSession,
})
...
base_config.update_blueprint({
    ...
    'sa_auth.cookie_secret': "e8358160-6537-4abb-9acc-b766d3383248",
